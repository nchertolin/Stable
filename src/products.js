...
const programms = [
  {
    ...
    description: ['Мойка арок, дисков, шин, ковриков.', 'Бесконтактная мойка первичным составом.', 'Ручная мойка автошампунем.', 'Промывка шильдиков, стекольных рам и решетки радиатора кистью.', 'Сушка кузова турбосушкой и полотенцем.']
  },
  {
    ...
    description: ['Двухфазная программа.', 'Консервация ЛКП премиальным полимером.']
  },
  {
  ...
  },
  {
    ...
    times: ['1ч 30мин', '2ч'],
    description: ['Комплексная двухфазная программа.', 'Консервация ЛКП премиальным полимером.']
  },
  {
...
const other = [
  ...
  },
  {
    ...
    prices: [],
    times: ['60ч', '90ч'],
    description: ['Химчистка салона с полным разбором салона', 'Экотуман для устранения химического запаха']
  },
  {
  ...
  },
  {
    ...
    times: ['10мин', '15мин'],
    description: ['Мойка коврика', 'Пылесос', 'Влажная уборка']
  }
]
